    ...
    <div class="header-navbar navbar-expand-sm navbar navbar-horizontal floating-nav navbar-light navbar-shadow menu-border container-xxl" role="navigation" data-menu="menu-wrapper" data-menu-type="floating-nav">
        ...
        <div class="navbar-container main-menu-content" data-menu="menu-container">
            ...
            <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="dropdown nav-item" data-menu="dropdown"><a class=" nav-link d-flex align-items-center" href="{{route('dashboard')}}" ><i data-feather="home"></i><span>Dashboards</span></a>
                    <ul  data-bs-popper="none"></ul>
                </li>
                <li class="dropdown " data-menu="dropdown"><a class=" nav-link d-flex align-items-center" href="{{route('userManage')}}" ><i data-feather="users"></i><span>Gestion d'utilisateurs</span></a>
                    <ul  data-bs-popper="none"></ul>
                </li>
                <li class="dropdown " data-menu="dropdown"><a class=" nav-link d-flex align-items-center" href="{{route('source.index')}}" ><i data-feather="paperclip"></i><span>Gestion de source</span></a>
                    <ul  data-bs-popper="none"></ul>
                </li>
                <li class="dropdown " data-menu="dropdown"><a class=" nav-link d-flex align-items-center" href="{{route('thematique.index')}}" ><i data-feather="archive"></i><span>Gestion des thèmes</span></a>
                    <ul  data-bs-popper="none"></ul>
                </li>
