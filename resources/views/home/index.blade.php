...
<section class="portal-cta py-4">
    <div class="container text-center">
        <p class="mb-3 text-white">Parcourez la bibliothèque publique, ou proposez un document sans compte.</p>
        ...
        <a href="{{ route('documents.submit') }}" class="btn btn-outline-light">Proposer un document</a>
    </div>
</section>
@endguest
@endsection
