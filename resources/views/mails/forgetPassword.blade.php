...
<head>
  ...
  <![endif]-->
    <title>Email de Réinitialisation</title>
    <link
...
<body
    ...
    <div style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: none;">Default email
        preheader</div>
                                ...
                                <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
                                    <tr>
                                        <td class="sm-px-24"
                                            ...
                                            <h3>
                                                Veuillez donc cliquer sur le bouton ci-dessous  <br>
